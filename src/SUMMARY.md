...
- [コマンド](./Command/README.md)
  ...
  - [宣言的コマンド]()
    ...
    - [deriving: 型クラスのインスタンス生成](./Command/Declarative/Deriving.md)
    - [example: 名前をつけずに証明をする](./Command/Declarative/Example.md)
    ...
    - [noncomputable: 関数を計算不能に](./Command/Declarative/Noncomputable.md)
    - [notation: 記法を導入する](./Command/Declarative/Notation.md)
    - [open: 名前空間を開く](./Command/Declarative/Open.md)
    - [partial: 再帰関数の停止証明をしない](./Command/Declarative/Partial.md)
