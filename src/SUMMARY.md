...
- [コマンド](./Command/README.md)
  ...
  - [#guard_msgs: メッセージのテスト](./Command/GuardMsgs.md)
  ...
  - [open: 名前空間を開く](./Command/Open.md)
  - [partial: 再帰関数の停止証明をしない](./Command/Partial.md)
  - [private: 定義を不可視にする](./Command/Private.md)
  - [proof_wanted: 証明を公募する](./Command/ProofWanted.md)
  - [protected: フルネームを強制する](./Command/Protected.md)
  - [scoped: 有効範囲を名前空間で限定](./Command/Scoped.md)
